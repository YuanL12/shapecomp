...
public:
	...
	// id of the reference vertex this vertex is a duplicate of some vertex, else -1
	int referenceIndex;

	// variables used for Tutte Embedding 
	// id of the vertex in the set of boundary vertices or interior vertices 
	int indexN;
	bool onBoundaryTutte;
